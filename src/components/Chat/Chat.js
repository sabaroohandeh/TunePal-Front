...
class Chat extends React.Component {
    ...
    componentDidMount() {
        Axios.get("http://localhost:8000/chat/", tokenConfig())
        .then(res => {
    ...
    getMessages = (conversationID) => {
        Axios.get(`http://localhost:8000/chat/${conversationID}/`, tokenConfig())
        .then(res => {
    ...
    sendMessage = (message) => {
        ...
        Axios.post(`http://localhost:8000/chat/${conversationID}/`, toBackJSON, tokenConfig())
        .then(res => {
